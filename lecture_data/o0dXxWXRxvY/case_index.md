# Case Index — Lecture 6 (Fall 2014)
...
This lecture covers the economics of materials, university productivity (aside), coal and global externalities, the magnesium anode case as the spine of the corrosion thread, the Alcoa-Dow cartel, aluminum corrosion, the Aloha Airlines disaster, voltage and bond energy with electrocauterization as the closing case, the history of water-conveying materials, and an extended Eagle Scout forensic narrative on galvanized handrails.
...
### Alcoa–Dow Chemical magnesium cartel (post-WWII)
- **Anchor:** `§5.p6`–`§5.p9`
- **canonical_cluster_id:** Dow Chemical magnesium price cartel (1946–1975) / Alcoa monopoly and price fixing with Dow Chemical
- **Frame in this lecture:** Why Alcoa, with the technology to enter magnesium production, never did. Joel Clark's first doctoral student (George Kenney, ~1976) used sales-and-price data to prove the cartel.
- **Materials/systems:** primary magnesium, primary aluminum.
- **Era:** post-WWII through 1970s.
- **Source artifact:** *From Monopoly to Competition: The Transformation of Alcoa, 1888 to 1986* (Columbia Business School).
...
- **Frame in this lecture:** Ron Latanision's anecdote: water-based metallographic polishing solution corroded the composite faster than it could be polished. Used to demonstrate that magnesium's corrosion problem extends even to characterization in the lab.
...
- **Anchor:** `§10.p1`–`§10.p9`
- **canonical_cluster_id:** Church building galvanized handrails and light posts paint failure / 1986 church building galvanized steel handrail paint failure
- **Frame in this lecture:** Forensic case as personal narrative. Galvanized steel painted before zinc hydroxide formation specification observed → paint failed within a year. Acetic acid pre-treatment (hypothesized zinc acetate formation) → repaint lasted thirty years. Used to teach surface-chemistry preparation for paint adhesion on galvanized substrates.
- **Era:** 1986.
...
- Steel labor content: 50% in Tom's early career → 5% today (§1.p7).
- 1980s steel industry productivity growth: 4% per year; manufacturing 2%; services 0% (§1.p8).
- 1980s mining productivity growth: 7% per year; compounded over 20 years = 20× improvement (§1.p9).
- Material cost as fraction of total product cost: ~10% (§9.p1) — restated from prior lecture.
- DOE magnesium-in-automobiles research spend: ~$100 million per year for forty or fifty years (§5.p1).
- Commercial jetliner lifetime: ~100,000 flight hours (§7.p2).
- H₂O electrochemical breakdown: ~1.1 V (§8.p3).
- Al₂O₃ / MgO decomposition: <2 V, probably <1.5 V (§8.p4).
- Primary bond energy: 1–3 eV (§8.p5, §11.p9).
- Energy/wavelength relation: E (eV) = 12,400 / λ (Å) = 1.24 / λ (μm) (§11.p10).
- UV cutoff: <0.310 μm → ~4 eV (§11.p11).
- Atmospheric CO₂: ~300 ppm; zinc carbonate formation timescale: ~1 year (§9.p9).
- Magnesium anode purity spec: <7 ppm nickel (§4.p9).

## Open questions for case index methodology

- The PEX cluster in the canon is named for the brass-fitting failure mode, but Tom's treatment here is purely the manufacturing-technology / cross-linking-science angle. Whether to split into two clusters or keep one cluster with multiple framing facets is a methodology decision.
- The magnesium-anode case is large enough (ten paragraphs in this lecture, the spine of the corrosion thread) that it should probably be a canonical cluster rather than the proposed status here. Recommend promotion at reconciliation.