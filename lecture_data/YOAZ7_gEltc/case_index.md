# Case Index — Friction Welding (film screening, `YOAZ7_gEltc`)

*This lecture is a film screening rather than a Tom-voice lecture. The "cases" indexed here are the friction-welding application examples documented by the Manufacturing Technology, Inc. promotional film. None of these are Tom Eagar teaching cases in the usual sense — they are industrial case studies surfaced by a third-party source. They are indexed for cross-referencing against Tom's own discussions of friction welding in other lectures in the corpus.*
...
### Automotive turbocharger rotor (AiResearch / KKK / Schwitzer)
- **Anchor:** `§6.p4`
- **canonical_cluster_id:** Automobile drive shaft universal joint friction welding *(adjacent; not the same case)* — PROPOSED new: Automotive turbocharger rotor inertia welding (713C to SAE 4140)
- **Frame in this section:** Turbocharger rotor inertia welded by most major manufacturers worldwide. Used by Ford, GM, Saab, Mercedes-Benz, Alfa Romeo.
- **Materials/systems:** 713C nickel alloy, SAE 4140 steel.
- **Era:** late 1970s / early 1980s (turbocharger adoption wave for fuel efficiency, post-Arab oil embargo).
...
- **Upset typically 15% of workpiece diameter** (§3.p3) — quoted as a quality-control rule of thumb for inertia welds.
- **30% production-time reduction vs. traditional welding** (§6.p5) — for turbine components.
- **24% part-cost reduction** for Rockwell trailer brake cams (§8.p1).
- **370 pounds of nickel alloy saved per GE compressor ring assembly** vs. one-piece forging (§5.p2).

## Open questions

- The narration twice refers to manufacturer names that the captioner garbled (`Monison`, `Rockwell`). Both are likely identifiable from the film's video footage and from cross-reference to the friction-welding equipment customer base of Manufacturing Technology, Inc. circa 1980. Flagged for editor.
- The §10.p2 background-voice fragment is the only candidate Tom-voice content in this transcript. Audio verification is needed to determine whether this is Tom or a student, and whether it represents a real teaching moment to preserve at higher resolution.
- None of the cases in this film are currently in the canonical cluster list. All are marked PROPOSED. If Tom discusses any of these applications (Caterpillar, Schwinn, sucker rods, etc.) elsewhere in the corpus, the proposed clusters should be reconciled against his teaching cases — but the film itself is not a Tom teaching unit and the cases probably belong in a separate "promotional film references" sub-index rather than the canonical case list. Flagged for editor.