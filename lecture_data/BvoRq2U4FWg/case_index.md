# Case Index — Lecture BvoRq2U4FWg (3.371, Spring 2016, 10/12)
...
This lecture is built around the conceptual arc from Griffith's 1925 energy criterion through the Liberty ship inquiry to modern fracture mode identification. It surfaces several developed teaching cases and a number of framing references.
...
## Framing references (not developed cases)
...
- **Anchor:** `§2.p4`
- **canonical_cluster_id:** None directly — Tom references "nuclear submarines" generically without naming a class. Possibly maps to `Nautilus submarine hull material (HY-80)` or similar; not specific enough to assert.
- **Frame:** $22 billion vessel, very high toughness specs justified by criticality.

### Northridge earthquake (see above)
...
- **Charpy V-notch toughness thresholds**: 5 ft-lb (failed plates) → 10 (Navy) → 15 (safety factor) → 20 (Coast Guard 1960) → 60-70 (line pipe, 1970s). §2.p3.
- **20.2 ft-lb / 20.5 ft-lb / 30 ft-lb**: Sparrows Point plate averages and the runoff-fraud outlier. §2.p5–6.
- **Brittle-ductile transition cutoffs**: 0.2% strain (metallurgist) / 0.5% (pipeline) / 5% (designer minimum). §5.p2–3.
- **75% reduction in area**: Acela copper conductor tensile bar. §6.p1.
- **10,000 hours to expert**: §7.p1.
- **99.5% metallurgists / 10% mechanical engineers do fracture mechanics**: §8.p3.

## People referenced

- **A. A. Griffith** — 1925 energy criterion. §2.p1, §4.p2, §9.p3.
- **Walter Backofen** — Tom's sophomore-year professor; "the longer you think about the tensile test, the less you understand it." §7.p2.
- **W. David Kingery** — MIT Ceramics; mid-1950s ice strength research. §3.p3.
- **Régis Pelloux** — MIT faculty, brought in for LNG tail shaft analysis. §8.p1.
- **Rob Ritchie** — formerly MIT ME, now Berkeley/LBL; 2014 *Science* paper on high-entropy alloy. §9.p1.
- **Jim Rice** — Lehigh / Brown / Harvard; developed J-integral; "the god of fracture"; fracking applications. §9.p2.
- **Paul Paris** — Ohio State; Paris fatigue equation; co-author of the handbook; "one of the most arrogant people you will ever meet." §9.p3.
- **George Irwin** — Naval Research Lab; "father of fracture mechanics"; worked with Pellini. §9.p3.
- **William Pellini** — NRL; explosion bulge test; referenced via Irwin. §9.p3.