# Case Index — Lecture Wg6ZWqT_Q9M (3.371 Spring 2016, session 8/12)

*Citation format: layer 3 paragraph anchor (e.g. `§5.p4`). Click-through reveals the corresponding layer 2 passage with timestamp range.*
...
### Corrugated stainless steel tubing — lightning perforation
- **Anchor:** `§2.p2`, `§2.p3`
- **canonical_cluster_id:** Corrugated stainless steel gas tubing lightning strike fires
- **Frame in this lecture:** Physical demonstration of the lightning-perforation failure. Six billion feet installed in US homes; manufacturing flaw + high-voltage discharge → perforation of the steel through the plastic jacket.
- **Materials/systems:** corrugated stainless steel tubing, polyethylene jacket
- **Era:** 2000s–present installation; contemporary failure mode
...
- **Related:** Diamond-coated asphalt tool development; Norton asphalt reclamation carbide-tip braze joint; Highway asphalt reclamation tool wear

### Rongeur — sapphire as structural material
- **Anchor:** `§5.p1`–`§5.p11`
- **canonical_cluster_id:** Rongeur (orthopedic surgical pliers) consulting work
...
- **Materials/systems:** stainless steel (30 Msi), sapphire (alumina, single-crystal), ruby, silicon carbide, diamond
- **Era:** ~1982
- **Note:** This is the lecture's anchor consulting case. The story braids together the Ashby-plot framing (§3), the medical-instruments cost structure (§5.p7–p8, parallel to the surgical-scissors case), and the sapphire-substrate-for-LEDs market story (§5.p5).
...
### Surgical scissors — medical liability and finish premium
- **Anchor:** `§5.p7`, `§5.p8`
- **canonical_cluster_id:** Surgical scissors (medical liability premium)
- **Frame in this lecture:** $300 (1980s) / $600–700 (present) stainless steel scissors with cobalt-alloy brazed cutting edge, gold-plated handles, 100% hardness check. DeBakey color-preference anecdote. Used to motivate the sapphire/ruby marketing pitch in §5.p9.
- **Note:** Recurs in the §1 worked example of lecture -6n9y2szRqo with different framing (there, scissors-as-medical-liability-premium; here, scissors-as-medical-pricing-context). Cluster appears confirmable across the corpus.
...
- **Anchor:** `§7.p2`, `§7.p4`
- **canonical_cluster_id:** Aluminum baseball bat *(adjacent — this is wood-bat context for the bat material discussion)*
- **Frame in this lecture:** Ash chosen for bats because it's the strongest wood on the Ashby plot; Kentucky ash availability is part of why Louisville is the bat-manufacturing center. Student question on maple goes unanswered.
- **Note:** Tom defers the metal-bat discussion ("a whole other topic"). Likely cross-references to the *Aluminum baseball bat*, *Baseball bat aluminum alloy development*, *Naval Surface Weapon Center baseball bat testing*, and *Baseball bat performance study* clusters.
...
- **Tungsten carbide cost:** $10,000/lb (§4.p1)
- **Sapphire boule cost:** ~$100,000 per beach-ball-sized boule (§5.p5)
- **Sapphire rod / tube retail:** $15 (rod) / $30 (foot of tube), ~1980s (§5.p11)
- **Sapphire stiffness:** ~2× steel (§5.p11)
- **Steel Young's modulus:** 30 Msi (§5.p3)
- **Diamond Young's modulus:** 60 Msi (§4.p1)
- **Aluminum tensile-test Young's modulus measurement spread:** 7–15 Msi across 15 students, true value 10 Msi (§3.p7)
- **Air Force propulsion R&D budget:** $300M/year over 20 years (§6.p3)
- **China sapphire-furnace order:** ~$300M (§5.p5)
- **Surgical scissors price:** $300 (1980s) → $600–700 (present) (§5.p7)
- **Brittle-flaw strength loss:** 80–90% from a flaw in brittle material (§8.p3)

## Notes on case taxonomy

The rongeur case is the structural spine of this lecture: it motivates the Ashby-plot framework (§3), the strength/cost data on tungsten carbide and sapphire (§4–§5), the sapphire-substrate market digression (§5.p5), and the surgical-scissors price-structure parallel (§5.p7–p8). The National Aerospace Plane / Mach 17 sequence (§6) functions as a "what happens when engineers ignore the Ashby plot" cautionary case. The Spruce Goose / baseball bats material (§7) and the Galileo/Griffith/Timoshenko fracture-toughness opening (§8) pivot toward the next lecture's content.