# Case Index — Lecture 3 (`42alE7nc_-Y`)

*Citation format: layer 3 paragraph anchor (e.g. `§9.p2`).*

This is a definitional / autobiographical lecture rather than a case-driven one. The "cases" here are mostly institutional and biographical: MIT, GE, the National Academies, Tom's department headship. Three discrete case-like teaching units appear, plus several historical figures used as examples.
...
## Historical figures used as definitional examples

(Not cases proper — used as quotable authorities or biographical sketches.)

- **Benjamin Wright** (`§3.p2`) — first civil engineer in the United States; built the Erie Canal.
- **Isaac Asimov** (`§4.p2`) — quoted on engineering and economics.
- **Gordon S. Brown** (`§4.p2`–`§4.p4`) — MIT Dean of Engineering who pivoted MIT from engineering practice to engineering science in the 1950s.
- **Merton Flemings** (`§4.p3`) — Tom's predecessor as department head; cited as a "real engineer" who had to recast himself as a scientist to get tenure under Brown.
- **Theodore von Karman** and **James Michener** (`§4.p7`) — quoted on the scientist/engineer distinction.
- **Thomas Edison** (`§5.p1`–`§5.p3`) — two 1911 and 1912 quotes praising MIT engineers.
- **Elihu Thomson** (`§5.p3`–`§5.p4`) — co-founder (with Edison) of General Electric; acting president of MIT 1920–1923; biographical sketch.
- **Abraham Lincoln** (`§7.p1`) — chartered the National Academy of Sciences in 1863.
- **Norm Augustine** (`§7.p4`–`§7.p5`) — CEO of Lockheed Martin, MIT Corporation member, author of *Augustine's Laws*; cited for his "ages of engineering" framework (mechanical from mid-1700s, electrical from 1879, information from 1906, socio-engineering from 1979).
- **Freeman Dyson** (`§6.p6`) — quoted: "A good engineer is a person who makes a design that works with as few original ideas as possible."
- **Daniel Kahneman** (`§4.p6`, `§11.p3`) — *Thinking, Fast and Slow*; system one / system two thinking framework, used as a lens for both the cold-diagnosis example and the chauvinism-recognition lesson.
- **L. Rafael Reif** (`§8.p3`) — incoming MIT president (as of Fall 2015 framing); cited as an electrical engineer.

## Figures referenced (framing statistics, not cases)

- **Engineering graduation by discipline.** ~83,000 total engineers graduated per year; mechanical 19,000 (>20%); civil second; materials ~1,100; petroleum just after materials. (`§8.p1`, `§8.p4`–`§8.p6`)
- **National Academy of Engineering membership ratios.** ~2,200 NAE members vs ~2.2 million engineers in the U.S. — about 1 in 1,000. ~98% male historically, climbing toward 5% female. (`§7.p2`)
- **MIT bachelor's degrees.** 666 total, MIT 25th nationally; 289 awarded to women (~43%); broken down by minority: Asian-American 165, African-American 46, Hispanic 76. (`§8.p9`, `§9.p1`)
- **MIT department rankings.** Most School of Engineering departments ranked #1 in their fields; School of Science the opposite — physics and chemistry not #1, only a few are. (`§8.p2`)
- **MIT female undergraduate fraction over time.** <10% in 1968; ~45% by Fall 2015. (`§8.p9`)