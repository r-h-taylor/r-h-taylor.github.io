...
- **Frame in this lecture:** Recap from a prior session. Used as the canonical TPM example — a two-dollar pin that a maintenance engineer never replaced caused several percent scrap. Setup for the broader discussion of acceptable-defect thresholds.

### Motorola Boynton Beach pager manufacturing
- **Anchor:** `§2.p3`, `§2.p4`, `§2.p5`, `§2.p6`
- **canonical_cluster_id:** "Motorola Boynton Beach pager manufacturing"
- **Frame in this lecture:** Around 1989-1990, Motorola brought pager manufacturing back from Singapore to Boynton Beach, automated the process, cut turnaround from six weeks to one-to-two weeks, and — by eliminating the planned 5% repair area — drove defects to zero. Used to illustrate the zero-defects principle and how repair-area sizing defines engineering tolerance for defects.
- **Era:** ~1989-1990; Motorola was an early National Quality Award winner.

### Ford Mustang assembly line non-start defect
- **Anchor:** `§3.p1`, `§3.p2`
- **canonical_cluster_id:** "Ford Mustang assembly line non-start defect"
- **Frame in this lecture:** Early 1990s. New manager eliminated tow motors for cars that wouldn't start at end-of-line; hourly workers had to push the cars 150 yards, complained to engineers, and engineers fixed the underlying defect. Parallel to the Motorola case: removing the slack defines the engineering effort applied to the defect rate.
- **Era:** Early 1990s.
...
- **Zero defects** (TPM principle) — §2.p6.
- **Total Productive Maintenance** — §2.p1, §4.p1.
- **Rule of thumb: 5% repair expected in 1980s electronics manufacturing** — §2.p5.
- **Douglas McGregor's Theory X and Theory Y** — §5.p7.
- **AWS Structural Welding Code definition of QC/QA** — §6.p1, §6.p2.
- **Four global maritime certification agencies** (ABS, DnV, Bureau Veritas, Lloyd's of London) — §6.p4.
- **SUBSAFE program** — §7.p1, §8.p5 (Thresher loss, Admiral Rickover, Edwards Deming lineage).
- **ISO 9000 principles** (customer focus, leadership, involvement of people, process approach, systems approach, continual improvement, factual decision-making, supplier relationships) — §8.p1.
- **Malcolm Baldrige National Quality Award** — §8.p4. ~113 awards through 2016; managed by NIST; Malcolm Baldrige died in a rodeo accident.
- **Title 21 CFR (FDA Good Manufacturing Practice)** — §8.p7.
- **ISO 9000 vs. ISO 9001 distinction** — §8.p8.
- **Boyle v. United Technologies (likely) — design-defect immunity for defense contractors** — §9.p2.

## Books cited

- Rudolf Stapelberg, ~1100 pages on design/reliability/maintainability/safety — §4.p1.
- Karl Ulrich and Steve Eppinger, *Product Design and Development* (fifth edition) — §4.p2, §4.p3, §4.p4.