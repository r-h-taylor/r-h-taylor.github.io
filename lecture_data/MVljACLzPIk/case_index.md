# Case Index — Lecture MVljACLzPIk (Solid State Welding, Spring 2013, session 8/12)

*Citation format: layer 3 paragraph anchor (e.g. `§7.p3`).*
...
### Etruscan gold-bead jewelry (TLP precedent, ~600 BC)
- **Anchor:** `§5.p9`, `§6.p3`
- **canonical_cluster_id:** "Etruscan gold bead diffusion bonding"
- **Frame in this lecture:** Etruscan gold earrings used tin between copper-base and gold beads to make TLP diffusion bonds, ~600 BC. Sectioned jewelry shows tin gradient by microprobe. Tom's rhetorical move: "the Etruscans didn't file an infringement" against the Pratt & Whitney patent.
- **Era:** ~600 BC
- **Materials/systems:** Tin / copper-gold
...
- **Anchor:** `§4.p3`
- **Note:** Framing figure, not a case. Tom uses the per-aircraft cost to contextualize weight-saving economics.
...
- **Cost-per-pound saved by application:** $2/lb (automobile), $200/lb (aircraft), $2,000/lb (aircraft engine), $20,000/lb (spacecraft). §2.p7, §2.p8.
- **Diffusion bonding window:** 0.6 to 0.8 of absolute melting point (Kelvin); 5000 psi fixturing pressure; 10–20 hour furnace time; ~$1,000/hour furnace operating cost. §2.
- **TLP fixturing pressure reduction:** 5 psi vs 5000 psi conventional diffusion bonding. §7.p8.
- **Blade tolerance:** 1–10 ten-thousandths of an inch (~2.5–25 microns) on Christmas-tree root grinds. §3.p3.
- **Blisk weight cascade:** 1 lb off disc → 20 lb off engine → 200 lb off aircraft. §4.p2.
- **Au-Ni eutectic:** 955°C at 18% Ni, 82% Au. §7.p4.
- **Au gold melting point:** 1064.43°C (international temperature standard). §7.p4.
- **Pb-Sn eutectic:** 183°C at 63% Sn, 37% Pb. §8.p3.
- **Molybdenum thermal diffusivity:** 60% that of pure copper. §7.p7.